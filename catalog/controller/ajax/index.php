...
class ControllerAjaxIndex extends Controller
{
    public function index()
    {
        ...
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_tamplate') . '/template/ajax/index.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_tamplate') . '/template/ajax/index.tpl', $data));
        } else {
